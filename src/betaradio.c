/* betaradio.c generated by valac 0.14.0, the Vala compiler
...
static void* ___lambda0_ (BetaRadio* self);
static void __lambda1_ (BetaRadio* self, GtkCheckMenuItem* e);
GType gst_player_get_type (void) G_GNUC_CONST;
GstPlayer* gst_player_get_instance (void);
void gst_player_stop (GstPlayer* self);
static void ___lambda1__gtk_check_menu_item_toggled (GtkCheckMenuItem* _sender, gpointer self);
...
static void ________lambda2_ (Block1Data* _data1_, GtkCheckMenuItem* e);
void gst_player_play (GstPlayer* self, const gchar* url);
static void _________lambda2__gtk_check_menu_item_toggled (GtkCheckMenuItem* _sender, gpointer self);
JsonSoup* json_soup_grandparent (JsonSoup* self);
static Block2Data* block2_data_ref (Block2Data* _data2_);
static void block2_data_unref (Block2Data* _data2_);
static void _____lambda3_ (Block2Data* _data2_, GtkCheckMenuItem* e);
static void ______lambda3__gtk_check_menu_item_toggled (GtkCheckMenuItem* _sender, gpointer self);
...
static void* ___lambda0_ (BetaRadio* self) {
	...
	g_signal_connect_object ((GtkCheckMenuItem*) stop, "toggled", (GCallback) ___lambda1__gtk_check_menu_item_toggled, self, 0);
	...
	g_signal_connect_object ((GtkCheckMenuItem*) quit, "toggled", (GCallback) ___lambda4__gtk_check_menu_item_toggled, self, 0);
...
BetaRadio* beta_radio_construct (GType object_type) {
	...
	{
		g_thread_create (____lambda0__gthread_func, self, TRUE, &_inner_error_);
	...
	__catch0_g_thread_error:
	{
		...
		g_debug ("betaradio.vala:84: %s", _tmp5_);
		_g_error_free0 (e);
	}
	__finally0:
	if (_inner_error_ != NULL) {
				...
				size = _tmp23_;
				{
					...
					j = 0;
					{
						...
						while (TRUE) {
							...
							_tmp52_ = radio;
							g_signal_connect_data ((GtkCheckMenuItem*) _tmp52_, "toggled", (GCallback) _________lambda2__gtk_check_menu_item_toggled, block1_data_ref (_data1_), (GClosureNotify) block1_data_unref, 0);
							_tmp53_ = json;
	...
	length = _tmp1_;
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_tmp30_ = radio;
				g_signal_connect_data ((GtkCheckMenuItem*) _tmp30_, "toggled", (GCallback) ______lambda3__gtk_check_menu_item_toggled, block2_data_ref (_data2_), (GClosureNotify) block2_data_unref, 0);
				_tmp31_ = json;
